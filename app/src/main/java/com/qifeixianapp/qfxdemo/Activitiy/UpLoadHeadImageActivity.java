...
import com.qifeixianapp.qfxdemo.tool.UploadUtil;
...
public class UpLoadHeadImageActivity extends AppCompatActivity implements View.OnClickListener, UploadUtil.OnUploadProcessListener {
    ...
    private void toUploadFile() {
        ...
        uploadUtil.setOnUploadProcessListener(UpLoadHeadImageActivity.this); //设置监听器监听上传状态
